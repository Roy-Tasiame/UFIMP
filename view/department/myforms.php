...
<body>
    ...
    <div class="sidebar">
        ...
        <nav class="sidebar-nav">
            <div class="nav-item">
                <a href="departmentdashboard.php" class="nav-link">
        ...
        <div class="forms-container">
            ...
            <div class="dashboard-summary">
                <div class="summary-card">
                    ...
                    <div class="summary-card-value"><?php echo countFormsByUser($conn, $userId); ?></div>
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-card-value"><?php echo countTotalResponsesByUser($conn, $userId); ?></div>
                    <div class="summary-card-trend">
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-card-value"><?php echo countRecentFormResponsesByUser($conn, $userId); ?></div>
                    <div class="summary-card-trend">
            ...
            <div class="forms-grid" id="formsGrid">
                <!-- Sample Form Card -->
                 <?php
                 $forms = getAllFormsByUser($conn, $userId);
